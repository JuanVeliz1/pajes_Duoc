...
usuarios = {}
def dato():
    with open ("compraBoletosVuelo.json","w") as archivo:
        json.dump(usuarios, archivo, indent=4)
        print("los datos han sido guardados de manera exitosa en libreriaPasajes.json")
...
def comprar_asiento(asientos):
    ...
    telefono = input("Ingrese su numero telefónico (con numeral 9 al inicio): ")
    ...
    while True:
        ...
        try:  
                ...
                if opcion == 1:
                    ...
                    mostrar_asientos(asiento)
                elif opcion == 2:
                    print ("COMPRAR ASIENTOS")
                    comprar_asiento(asiento)
                elif opcion == 3:
                    print ("ANULAR VUELO")
                    anular_asiento(asiento)
                elif opcion == 4:
                    print ("MODIFICAR DATOS")
                    modificar_datos_pasajero(asiento)
                elif opcion == 5:
                    print ("Saliendo...")
                    break
                else:
            ...
            print ("debe ser numeros entre 1 y 5 vuelva a intentar ingresando datos legibles ")
